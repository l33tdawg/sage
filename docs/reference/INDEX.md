...
| [`concepts/app-v28-lifecycle.md`](concepts/app-v28-lifecycle.md) | The app-v28 design contract, **not yet activated**: the public-memory Merkle commitment and the consensus-side co-commit tombstone rule both land in one fork, the ceiling bump is what activates them, and the evidence required first. |
