<!-- Reference index reconciled for SAGE v11.20.3. Core REST, MCP, concepts, Python SDK, federation/brain graph, reranker, and environment references are current-facing for v11. -->
...
| [`concepts/app-v28-lifecycle.md`](concepts/app-v28-lifecycle.md) | The app-v28 design contract, **not yet activated**: the public-memory Merkle commitment becomes AppHash-covered from H+1, the ceiling bump is what activates it, the evidence required first, and the co-commit tombstone index deliberately deferred. |
...
## Related docs (reconciled through v11.20.3)
