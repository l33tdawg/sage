<!-- Reference index reconciled for SAGE v11.2.0. Core REST, MCP, concepts, Python SDK, federation/brain graph, reranker, and environment references are current-facing for v11. -->
...
## Related docs (reconciled through v11.2.0)
